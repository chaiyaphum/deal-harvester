...
from card_retrieval.adapters.bbl.constants import BANK_NAME, PROMOTION_URL
...
class BblAdapter(BaseAdapter):
    """Bangkok Bank (BBL) credit-card promotion adapter — SCAFFOLD ONLY.
    ...
    async def fetch_promotions(self) -> list[Promotion]:
        raise NotImplementedError(
            "BBL adapter is a scaffold — see src/card_retrieval/adapters/bbl/PLAN.md"
        )
